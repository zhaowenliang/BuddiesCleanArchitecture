...
package cc.buddies.cleanarch.common.recyclerview;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int computeDividerCount(RecyclerView parent) {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        final int childCount = computeDividerCount(parent);
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent,
        ...
        boolean isLast = lastPosition == position;
        if (mOrientation == VERTICAL) {
            int bottom = isLast ? 0 : mDivider.getIntrinsicHeight();
            outRect.set(0, 0, 0, bottom);
        } else {
            int right = isLast ? 0 : mDivider.getIntrinsicWidth();
